...
const BlogDetails = (props) => {
  ...
  const HandleKeepReading = (updateID) => {
    id = updateID
    setLoading(true)
    getBlog();
  }
      ...
      <div className="blog-details-section">
        <div className="container">
          ...
          {isloading ? (
              ...
              <ContentLoader viewBox="0 0 400 130" height={200} width={'50%'} {...props}>
          ...
          <div className="row">
            <div className="blog-details-left">
              ...
              {isloading ? (
                <ContentLoader viewBox="0 0 500 280" className='pic-div' backgroundColor="#d9d9d9"
                  foregroundColor="#ffffff" {...props}>
                  <rect x="3" y="3" rx="10" ry="10" width="100%" height="100%" />
                  <rect x="4" y="190" rx="0" ry="0" width="100%" height="100%" />
                  <rect x="4" y="210" rx="0" ry="0" width="100%" height="100%" />
                  <rect x="4" y="230" rx="0" ry="0" width="100%" height="100%" />
                </ContentLoader>
              ) : (
              ...
              <ul>
                {isloading ? (
                  Array.apply(null, { length: 10 }).map((e, i) => (
                    <ContentLoader viewBox="0 0 400 31" style={{ height: 51, width: '100%' }} backgroundColor="#d9d9d9"
                      foregroundColor="#ffffff" {...props}>
                  ...
                  <ul>
                    {keepreading && keepreading.map((data) => {
                      return (
                        <li>
                          <Link to={`/blog-details/${data.blogId}`} onClick={() => HandleKeepReading(data.blogId)} style={{ color: '#0E6EB8' }}>
                            {data.title}
                          </Link>
                        </li>
                      )
