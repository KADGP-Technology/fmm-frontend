          ...
          <div className="container">
            <div className="privacy-policy-inner">
              <div className="content-section">
                ...
                <p>
                Welcome to Viprom Technologies LLp.

                </p>
                <p>
                Viprom Technologies LLp (“us”, “we”, or “our”) operates www.findmymua.com (hereinafter referred to as “Service”).

                </p>
                <p>Our Privacy Policy governs your visit to www.findmymua.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.
</p>
...
<p>Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy constitutes your agreement with us (“agreement”).
              ...
              <div className="content-section">
                ...
                <p>
                SERVICE means the www.findmymua.com website operated by Viprom Technologies LLp.
...
While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you (“Personal Data”). Personally identifiable information may include, but is not limited to:
                ...
                <li>0.1. Email address
</li>
                <li>0.2. First name and last name
</li>
                <li>0.3. Phone number
</li>
                <li>0.4. Address, Country, State, Province, ZIP/Postal code, City
</li>
                <li>0.5. Cookies and Usage Data
</li>
...
<h2>Examples of Cookies we use:
</h2>
<li>0.1. Session Cookies: We use Session Cookies to operate our Service.
</li>
<li>0.2. Preference Cookies: We use Preference Cookies to remember your preferences and various settings.
</li>
<li>0.3. Security Cookies: We use Security Cookies for security purposes.
</li>
<li>0.4. Advertising Cookies: Advertising Cookies are used to serve you with advertisements that may be relevant to you and your interests.
</li>
<h3>Other Data
</h3>
<p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, NDA agreements, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
              ...
              <div className="content-section">
                ...
                {/* <h2>1. Introduction</h2> */}
                <p>
                Viprom Technologies LLp uses the collected data for various purposes:


                </p>
              <li>0.1. to provide and maintain our Service;
</li>
              <li>0.2. to notify you about changes to our Service;</li>
              <li>0.3. to allow you to participate in interactive features of our Service when you choose to do so;
</li>
              <li>0.4. to provide customer support;
</li>
              <li>0.5. to gather analysis or valuable information so that we can improve our Service;</li>
              <li>0.6. to monitor the usage of our Service;
</li>
              <li>0.7. to detect, prevent and address technical issues;</li>
              <li>0.8. to fulfil any other purpose for which you provide it;
</li>
              <li>0.9. to carry out our obligations and enforce our rights arising from any contracts entered into between you and us, including for billing and collection;
</li>
              <li>0.10. to provide you with notices about your account and/or subscription, including expiration and renewal notices, email-instructions, etc.;
</li>
              <li>0.11. to provide you with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless you have opted not to receive such information;
</li>
              <li>0.12. in any other way we may describe when you provide the information;
</li>
              <li>0.13. for any other purpose with your consent.
</li>
              </div>
              <div className="content-section">
                <h2>6. Retention of Data
</h2>
                <p>
...
If you are located outside India and choose to provide information to us, please note that we transfer the data, including Personal Data, to India and process it there.
              ...
              <p>Viprom Technologies LLp will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
</p>
              </div>
              <div className="content-section"> 
                <h2>7. Transfer of Data
...
0.2.7. if we believe disclosure is necessary or appropriate to protect the rights, property, or safety of the Company, our customers, or others.<br/>
              ...
              <div className="content-section"> 
                <h2>10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)
</h2>
                <p>
...
If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at contact@findmymua.co.<br/>
...
0.4. users are able to change their personal information by emailing us at contact@findmymua.co.<br/>
...
You can enable or disable Do Not Track by visiting the Preferences or Settings page of your web browser.<br/>
              ...
              <div className="content-section"> 
               ...
               <h5>0.1. What personal information we have about you. If you make this request, we will return to you:</h5>
               <p>0.0.1. The categories of personal information we have collected about you.<br/>
...
<h5>0.2. To delete your personal information. If you make this request, we will delete the personal information we hold about you as of the date of your request from our records and direct any service providers to do the same. In some cases, deletion may be accomplished through de-identification of the information. If you choose to delete your personal information, you may not be able to use certain functions that require your personal information to operate.
</h5>
<h5>0.3. To stop selling your personal information. We don’t sell or rent your personal information to any third parties for any purpose. We do not sell your personal information for monetary consideration. However, under some circumstances, a transfer of personal information to a third party, or within our family of companies, without monetary consideration may be considered a “sale” under California law. You are the only owner of your Personal Data and can request disclosure or deletion at any time.
</h5>
<p>If you submit a request to stop selling your personal information, we will stop making such transfers.<br/>
Please note, if you ask us to delete or stop selling your data, it may impact your experience with us, and you may not be able to participate in certain programs or membership services which require the usage of your personal information to function. But in no circumstances, we will discriminate against you for exercising your rights.<br/>
To exercise your California data protection rights described above, please send your request(s) by email: contact@findmymua.co.<br/>
...
For example, the outlined privacy policy has been made using PolicyMaker.io, a free tool that helps create high-quality legal documents. PolicyMaker’s privacy policy generator is an easy-to-use tool for creating a privacy policy for blog, website, e-commerce store or mobile app.
              ...
              <div className="content-section"> 
                <h2>20. Changes to This Privacy Policy
</h2>
                <p>
...
You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.<br/>
              ...
              <div className="content-section"> 
                ...
                <p>
                If you have any questions about this Privacy Policy, please contact us by email: contact@findmymua.co
    </p>
